...
namespace MonoDragons.ZFS.GUI.Menus
{
    public class SwitchWeaponsMenu : IVisual
    {
        ...
        public SwitchWeaponsMenu(ClickUI clickUI)
        {
            ...
            _switchWeaponsButton = Buttons.Text(ctx, 0, "Switch Weapons", () => CurrentData.CurrentCharacter.Gear.SwitchWeapons(), () => _show);
        ...
        private void Show()
        {
            if (CurrentData.CurrentCharacter.Team.IsIncludedIn(TeamGroup.NeutralsAndEnemies))
                return;
